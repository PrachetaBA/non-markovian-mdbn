...
def construct_dbn_hypoexp_m1_data(input_filename, output_filename, sampling_rate):
    """
    Function to construct discrete-time sub-sampled DBN data from Hypoexp/M/1 simulation data
    ----------
    Arguments:
...
if __name__ == "__main__":
    ...
    input_file = f"simulation/hypoexp-m1-{time_series_experiment}.csv"
    ...
    discrete_time_file = output_path / f"hypoexp-discrete-time-dbn-exp-{experiment_number}.csv"

    # call the subsampling function
    construct_dbn_hypoexp_m1_data(input_path, discrete_time_file, sampling_interval)
