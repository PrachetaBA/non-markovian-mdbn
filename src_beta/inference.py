...
def run_inference_hypoexp(dbn, query, delta):
    """Function to run inference on the beta HypoExp/M/1 DBN.
...
if __name__ == "__main__":
    ...
    output_filename = f"{results_folder}/beta-posterior-exp-{experiment_number}.pkl"
