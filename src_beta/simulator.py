...
if __name__ == "__main__":
    ...
    outpath = output_root / f'beta_hypoexp-m1-{args.experiment_number}.csv'
    ...
    for dist in arrival_distributions:
        ...
        for mu in service_rates:
            ...
            logger.info(f"Optimal subsampling interval for alpha={alpha}, beta={beta_param}, mu={mu} = {delta}")
    ...
    if len(df_list) > 0:
        ...
        df = df[["Run","Alpha","Beta","Phase_Rates","Mu","Current_Phase","IQL","End","Time","Event","Queue_Length"]]
